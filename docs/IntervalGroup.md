...
interval_group_instance = IntervalGroup.from_json(json)
# print the JSON string representation of the object
print(IntervalGroup.to_json())

# convert the object into a dict
interval_group_dict = interval_group_instance.to_dict()
# create an instance of IntervalGroup from a dict
interval_group_from_dict = IntervalGroup.from_dict(interval_group_dict)
```
