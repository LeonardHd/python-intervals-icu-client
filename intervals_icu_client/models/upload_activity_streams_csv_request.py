...
class UploadActivityStreamsCSVRequest(BaseModel):
    """
    UploadActivityStreamsCSVRequest
    """ # noqa: E501
    file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]] = Field(description="Activity streams CSV file")
