...
class ActivityPowerCurvePayload(BaseModel):
    """
    ActivityPowerCurvePayload
    """ # noqa: E501
    after_kj: Optional[StrictInt] = None
    secs: Optional[List[StrictInt]] = None
    curves: Optional[List[ActivityPowerCurve]] = None
    __properties: ClassVar[List[str]] = ["after_kj", "secs", "curves"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "secs": obj.get("secs"),
            "curves": [ActivityPowerCurve.from_dict(_item) for _item in obj["curves"]] if obj.get("curves") is not None else None
        })
        return _obj
