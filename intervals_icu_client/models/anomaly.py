...
class Anomaly(BaseModel):
    ...
    value_end: Optional[StrictInt] = Field(default=None, alias="valueEnd")
    __properties: ClassVar[List[str]] = ["start_index", "end_index", "value", "valueEnd"]
