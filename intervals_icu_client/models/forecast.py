...
class Forecast(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "provider", "location", "label", "lat", "lon", "enabled"]
    ...
    def provider_validate_enum(cls, value):
        ...
        if value not in set(['OPEN_WEATHER']):
            raise ValueError("must be one of enum values ('OPEN_WEATHER')")
        return value
