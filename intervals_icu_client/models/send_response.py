...
class SendResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "message", "new_chat"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of new_chat
        if self.new_chat:
            _dict['new_chat'] = self.new_chat.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "new_chat": Chat.from_dict(obj["new_chat"]) if obj.get("new_chat") is not None else None
        })
        return _obj
