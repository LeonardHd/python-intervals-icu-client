...
class DeleteEventsResponse(BaseModel):
    ...
    """ # noqa: E501
    events_deleted: Optional[StrictInt] = Field(default=None, alias="eventsDeleted")
    __properties: ClassVar[List[str]] = ["eventsDeleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventsDeleted": obj.get("eventsDeleted")
        })
        return _obj
