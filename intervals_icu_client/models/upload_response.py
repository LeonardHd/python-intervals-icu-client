...
class UploadResponse(BaseModel):
    ...
    activities: Optional[List[ActivityId]] = None
    __properties: ClassVar[List[str]] = ["icu_athlete_id", "id", "activities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "activities": [ActivityId.from_dict(_item) for _item in obj["activities"]] if obj.get("activities") is not None else None
        })
        return _obj
